...
- [GitHub Actions workflows](./.github/workflows/) for image build and deployment
...
This is intentionally scoped as a pre-production reference implementation. Known production gaps are documented in the account review report.